<script type="text/javascript">
    ...
    (function (window, $, undefined)
    {
        ...
        $.html5imageupload = function html5imageupload(options, element)
        {
            ...
            this.button.saving = '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Salvando...') + ' <i class="glyphicon glyphicon-time"></i></div>';
            this.button.zoomin = '<div class="btn btn-default btn-zoom-in" title="' + (this.options.zoominTitle || 'Aproximar imagem') + '"><i class="glyphicon glyphicon-resize-full"></i></div>';
            this.button.zoomout = '<div class="btn btn-default btn-zoom-out" title="' + (this.options.zoomoutTitle || 'Afastar imagem') + '"><i class="glyphicon glyphicon-resize-small"></i></div>';
            this.button.zoomreset = '<div class="btn btn-default btn-zoom-reset" title="' + (this.options.zoomresetTitle || 'Centralizar') + '"><i class="glyphicon glyphicon-fullscreen"></i></div>';
            this.button.cancel = '<div class="btn btn-danger btn-cancel" title="' + (this.options.cancelTitle || 'Cancelar') + '"><i class="glyphicon glyphicon-remove"></i> Cancelar</div>';
            this.button.done = '<div class="btn btn-success btn-ok" title="' + (this.options.okTitle || 'Salvar') + '"><i class="glyphicon glyphicon-ok"></i> Salvar</div>';
            this.button.del = '<div class="btn btn-danger btn-del" title="' + (this.options.delTitle || 'Apagar') + '"><i class="glyphicon glyphicon-trash"></i> Apagar</div>';
        ...
        $.html5imageupload.prototype = {
            _init: function ()
            {
                ...
                if (_self.options.onAfterInitImage)
                {
                    _self.options.onAfterInitImage.call(_self, _self);
                }
            },
            _bind: function ()
            {
            ...
            handleFile: function (event, element)
            {
                ...
                if (_self.options.onAfterSelectImage)
                {
                    _self.options.onAfterSelectImage.call(_self, response, _self);
                }
            },
            ...
            imageUnhandle: function ()
            {
                ...
                $('body').css({cursor: ''});
                if (_self.options.onAfterMoveImage)
                {
                    _self.options.onAfterMoveImage.call(_self, _self);
                }
            },
            ...
            imageReset   : function ()
            {
                ...
                if (_self.options.onAfterResetImage)
                {
                    _self.options.onAfterResetImage.call(_self, _self);
                }
            },
            imageFinal   : function ()
            {
                ...
                if (_self.options.onAfterProcessImage)
                {
                    _self.options.onAfterProcessImage.call(_self, _self);
                }
            },
            ...
            reset        : function ()
            {
                ...
                if (_self.options.onAfterCancel)
                {
                    _self.options.onAfterCancel.call(_self);
                }
            },
            resize       : function ()
            {
                ...
                if (options.buttonZoomin != false)
                {
                    $(tools).append($(_self.button.zoomin).on({
                        ...
                        'touchend mouseup mouseleave': function (e)
                        {
                            ...
                            if (_self.options.onAfterZoomImage)
                            {
                                _self.options.onAfterZoomImage.call(_self, _self);
                            }
                        }
                    }));
                }
