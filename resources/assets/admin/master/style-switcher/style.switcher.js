...
var styleSwitcher = {
    ...
    initialize: function () {
        var a = this, b = $("html").data("style-switcher-options"), c = $("#styleSwitcherScript").data("base-path") ? $("#styleSwitcherScript").data("base-path") : "", d = $("head"), e = $("#styleSwitcherScript").data("skin-src") ? $("#styleSwitcherScript").data("skin-src") : c + "master/less/skin-default.less";
        if (a.basePath = c, !this.initialized) {
            ...
            d.append($('<link rel="stylesheet/less">').attr("href", e)), d.append($('<link rel="stylesheet">').attr("href", c + "../master/style-switcher/bootstrap-colorpicker/css/bootstrap-colorpicker.css")), $.styleSwitcherCachedScript(c + "../master/style-switcher/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js").done(function (d, e) {
                ...
                }, $.styleSwitcherCachedScript(c + "master/less/less.js").done(function (d, e) {
    ...
    initializeSimpleMode: function () {
        var a = this, b = $("#header .header-logo img"), c = $("#header .header-logo img").attr("src"), d = '<div id="styleSwitcherSimple" class="style-switcher style-switcher-simple hidden-xs"><a id="styleSwitcherSimpleOpen" class="style-switcher-open" href="#"><i class="fa fa-cogs"></i></a></div>';
    ...
    build: function () {
        var a = this, b = a.container.find(".color-primary input"), c = a.container.find(".color-secondary input"), d = a.container.find(".color-tertiary input"), e = a.container.find(".color-quaternary input");
    ...
    setLayoutStyle: function (a, b) {
        ...
        var d = this.container.find(".options-links.layout"), e = this.container.find(".patterns");
    ...
    setWebsiteType: function (a) {
        var b = this.container.find(".options-links.website-type"), c = this.container.find(".options-links.layout");
